...
import (
	...
	"github.com/sila-chain/sila-hive/internal/libdocker"
...
- $HOME/.dockercfg`)
		...
		clients = flag.String("client", "go-sila", "Comma separated `list` of clients to use. Client names in the list may be given as\n"+
	...
	// See: https://github.com/sila-chain/sila-hive/issues/1200.
