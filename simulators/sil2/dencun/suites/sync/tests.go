...
var testSuite = hivesim.Suite{
	Name:        "sil2-deneb-sync",
	DisplayName: "SilaDeneb Sync",
	Description: `Collection of test vectors that use a ExecutionClient+BeaconNode+ValidatorClient testnet for SilaCancun+SilaDeneb and test syncing of the beacon chain.`,
	...
	Tests = append(Tests,
		...
		SyncTestSpec{
			BaseTestSpec: suite_base.BaseTestSpec{
				...
				DisplayName: "Sync From SilaDeneb Genesis",
				Description: `
