# SilaDeneb Reorg - Test Cases

Collection of test vectors that use a ExecutionClient+BeaconNode+ValidatorClient testnet for SilaCancun+SilaDeneb and test re-orgs of the beacon chain.
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-reorg/"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-reorg/test-reorg-from-capella-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-reorg/test-reorg-from-deneb-"
```
