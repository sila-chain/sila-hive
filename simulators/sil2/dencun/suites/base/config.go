...
var (
	...
	DEFAULT_CONFIG = &testnet.Config{
		...
		Sil1Consensus: &el.ExecutionPostMergeGenesis{},
	}
...
func (ts BaseTestSpec) GetValidatorKeys(
	...
	for index, key := range keys {
		...
		if ts.GenesisExecutionWithdrawalCredentialsShares > 0 &&
			...
			key.WithdrawalCredentialType = beacon.SIL1_ADDRESS_WITHDRAWAL_PREFIX
			key.WithdrawalExecAddress = beacon.Sil1Address{byte(index + 0x100)}
		}
