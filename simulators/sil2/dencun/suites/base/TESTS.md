# SilaDeneb Testnet - Test Cases

Collection of test vectors that use a ExecutionClient+BeaconNode+ValidatorClient testnet for SilaCancun+SilaDeneb.
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-testnet/"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-testnet/test-deneb-fork-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-testnet/test-deneb-genesis-"
```
