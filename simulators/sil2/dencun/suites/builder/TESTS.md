...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-builder/"
```
...
### - SilaDeneb Builder Workflow From Capella Transition
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-builder/test-builders-sanity-"
```
...
### - SilaDeneb Builder Builds Block With Invalid Beacon Root, Correct State Root
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-builder/test-builders-invalid-payload-attributes-beacon-root-"
```
...
### - SilaDeneb Builder Errors Out on Header Requests After SilaDeneb Transition
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-builder/test-builders-error-on-deneb-header-request-"
```
...
### - SilaDeneb Builder Errors Out on Signed Blinded Beacon Block/Blob Sidecars Submission After SilaDeneb Transition
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-builder/test-builders-error-on-deneb-unblind-payload-request-"
```
...
### - SilaDeneb Builder Builds Block With Invalid Payload Version
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-builder/test-builders-invalid-payload-version-"
```
...
### - SilaDeneb Builder Builds Block With Invalid Beacon Root, Incorrect State Root
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-builder/test-builders-invalid-payload-beacon-root-"
```
