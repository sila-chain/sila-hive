# SilaDeneb P2P Blobs Gossip - Test Cases
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/blob-gossiping-sanity-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/blob-gossiping-before-block-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/blob-gossiping-delay-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/blob-gossiping-one-slot-delay-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/invalid-equivocating-block-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/equivocating-block-and-blobs-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/equivocating-block-header-in-blob-sidecars-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/equivocating-block-header-in-blob-sidecars-2-"
```
...
```bash
./hive --client <CLIENTS> --sim sil2/dencun --sim.limit "sil2-deneb-p2p-blobs-gossip/equivocating-blobs-"
```
