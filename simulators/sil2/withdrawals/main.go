...
func main() {
	...
	withdrawalsSuite := hivesim.Suite{
		Name:        "sil2-withdrawals",
		Description: `Collection of test vectors that use a ExecutionClient+BeaconNode+ValidatorClient testnet for SilaShanghai+Capella.`,
	}
	builderSuite := hivesim.Suite{
		Name:        "sil2-withdrawals-builder",
		Description: `Collection of test vectors that use a ExecutionClient+BeaconNode+ValidatorClient testnet and builder API for SilaShanghai+Capella.`,
	}
