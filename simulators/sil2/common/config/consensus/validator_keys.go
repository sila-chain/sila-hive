...
import (
	...
	hbls "github.com/herumi/bls-sil-go-binary/bls"
	...
	util "github.com/wealdtech/go-sil2-util"
)
...
func (kd *ValidatorSetupDetails) WithdrawalCredentials() (out common.Root) {
	...
	} else if kd.WithdrawalCredentialType == common.SIL1_ADDRESS_WITHDRAWAL_PREFIX {
		copy(out[12:], kd.WithdrawalExecAddress[:])
		out[0] = common.SIL1_ADDRESS_WITHDRAWAL_PREFIX
	}
	return
}
