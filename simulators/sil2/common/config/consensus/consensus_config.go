...
import (
	...
	el_common "github.com/sila-chain/go-sila/common"
...
func BuildSpec(
	...
	// TODO: specify build-target based on preset, to run clients in sila-mainnet or minimal mode.
	// copy the default sila-mainnet config, and make some minimal modifications for testnet usage
	specCpy := *baseSpec
	spec := &specCpy
	...
	spec.Config.SIL1_FOLLOW_DISTANCE = 1
...
func ConsensusConfigsBundle(
	...
	return hivesim.Bundle(
		...
		hivesim.Params{
			"HIVE_SIL2_SIL1_GENESIS_HASH": executionGenesisHash.String(),
		},
	), nil
}
