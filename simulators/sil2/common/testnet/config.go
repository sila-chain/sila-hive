...
type Config struct {
	...
	*consensus_config.ConsensusConfig `json:"consensus_config,omitempty"`
	...
	Sil1Consensus   execution_config.ExecutionConsensus `json:"sil1_consensus,omitempty"`
...
func (a *Config) Join(b *Config) *Config {
	...
	if b.Sil1Consensus != nil {
		c.Sil1Consensus = b.Sil1Consensus
	} else {
		c.Sil1Consensus = a.Sil1Consensus
	}
...
func (c *Config) FillDefaults() error {
	...
	if c.SlotTime == nil {
		...
		if len(
			...
			// Otherwise, use the sila-mainnet 12 second slot time
