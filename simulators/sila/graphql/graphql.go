	...
	for i := 0; i < parallelism; i++ {
		...
		go func() {
			...
			for test := range testCh {
				url := "https://github.com/sila-chain/sila-hive/blob/master/simulators/sila/graphql/testcases"
...
func getParameters(genesis core.Genesis) hivesim.Params {
	return hivesim.Params{
		...
		"HIVE_FORK_TANGERINE":            genesis.Config.SIP150Block.String(),
		"HIVE_FORK_SPURIOUS":             genesis.Config.SIP155Block.String(),
