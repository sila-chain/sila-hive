...
func (b BadHashOnNewPayload) Execute(t *test.Env) {
	...
	t.CLMock.ProduceSingleBlock(clmock.BlockProcessCallbacks{
		...
		OnGetPayload: func() {
			...
			// Starting from SilaShanghai, INVALID should be returned instead (https://github.com/sila-chain/execution-apis/pull/338)
...
// (from Kintsugi Incident Report: https://notes.sila.org/@ExXcnR0-SJGthjz1dwkA1A/BkkdHWXTY)
