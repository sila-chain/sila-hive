...
import (
	...
	suite_auth "github.com/sila-chain/sila-hive/simulators/sila/engine/suites/auth"
	suite_cancun "github.com/sila-chain/sila-hive/simulators/sila/engine/suites/cancun"
	suite_engine "github.com/sila-chain/sila-hive/simulators/sila/engine/suites/engine"
	suite_excap "github.com/sila-chain/sila-hive/simulators/sila/engine/suites/exchange_capabilities"
	suite_withdrawals "github.com/sila-chain/sila-hive/simulators/sila/engine/suites/withdrawals"
...
var (
	...
	withdrawals = hivesim.Suite{
		...
		Description: `
	Test Engine API withdrawals, pre/post SilaShanghai.`[1:],
	}
	cancun = hivesim.Suite{
		Name: "engine-cancun",
		Description: `
	Test Engine API on SilaCancun.`[1:],
	}
)
