...
import (
	...
	gsil_beacon "github.com/sila-chain/go-sila/beacon/engine"
...
func ToBeaconExecutableData(pl *ExecutableData) (gsil_beacon.ExecutableData, error) {
	return gsil_beacon.ExecutableData{
...
func FromBeaconExecutableData(ed *gsil_beacon.ExecutableData) (ExecutableData, error) {
	return ExecutableData{
...
func ExecutableDataToBlock(ed ExecutableData) (*types.Block, error) {
	...
	return gsil_beacon.ExecutableDataToBlock(gethEd, versionedHashes, ed.ParentBeaconBlockRoot, nil)
}
