...
This is a 'simulator', which should be run from within [hive](https://github.com/sila-chain/sila-hive). 

## Cross client testing

Testing implementations of Sila clients has been a difficult task. A standard testcase repository has been maintained,
...
The [Sila Standard Testcases](https://github.com/sila-chain/tests) testcases have now been transformed so that the bulk of all tests can be expressed as blocktests. The framework consists
