...
const DEFAULT_PROVIDER_URL: &str = "http://testing.sila-mainnet.beacon-api.nimbus.team";
...
impl ConsensusProvider {
    ...
    pub async fn get_finalized_root(&self) -> Result<B256> {
        ...
        let url = format!("{}/sil/v1/beacon/blocks/finalized/root", self.base_url);
    ...
    pub async fn get_light_client_bootstrap(
        ...
        let url = format!(
            "{}/sil/v1/beacon/light_client/bootstrap/{}",
    ...
    pub async fn get_light_client_finality_update(
        ...
        let url = format!(
            "{}/sil/v1/beacon/light_client/finality_update",
            self.base_url
        );
        let data = make_request(&self.client, &url).await?;
    ...
    pub async fn get_light_client_optimistic_update(
        ...
        let url = format!(
            "{}/sil/v1/beacon/light_client/optimistic_update",
            self.base_url
        );
        let data = make_request(&self.client, &url).await?;
