...
import (
	...
	"github.com/sila-chain/sila-hive/internal/fakes"
	"github.com/sila-chain/sila-hive/internal/libhive"
	"github.com/sila-chain/sila-hive/internal/simapi"
)
	...
	wantClients := []*ClientDefinition{
		{
			...
			Meta:    ClientMetadata{Roles: []string{"sil1"}},
		},
		{
			Name:    "client-2",
...
func newFakeAPI(hooks *fakes.BackendHooks) (*libhive.TestManager, *httptest.Server) {
	defs := []*libhive.ClientDefinition{
		{Name: "client-1", Image: "/ignored/in/api", Version: "client-1-version", Meta: libhive.ClientMetadata{Roles: []string{"sil1"}}},
