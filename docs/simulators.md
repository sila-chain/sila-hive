...
```bash
mkdir ./simulators/sila/my-simulation
cd ./simulators/sila/my-simulation
go mod init github.com/sila-chain/sila-hive/simulators/sila/my-simulation
go get github.com/sila-chain/sila-hive/hivesim@latest
```
...
```bash
./hive --sim my-simulation --client go-sila,besu
```
...
[
  {
    "name": "go-sila",
    "version": "Sila/v1.10.0-unstable-8e547eec-20210224/linux-amd64/go1.16",
    "meta": {
      "roles": [
        "sil1"
      ]
...
documentation] for environment variables supported by Sila clients.
...
{"id":"abcdef1234","name":"go-sila_latest"}
```
...
[package hivesim]: https://pkg.go.dev/github.com/sila-chain/sila-hive/hivesim
