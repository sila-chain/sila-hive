...
func TestExtractClient(t *testing.T) {
	tests := []struct {
		...
		{"plain", "sil_getBalance/balance-0 (sila)", "sila"},
...
func TestCompileGlob(t *testing.T) {
	...
	tests := []struct {
		...
		{"sil_getBalance*", "sil_getBalance/balance-0", true},
		{"sil_getBalance/*", "sil_getBalance/balance-0", true},
		{"*getBalance*", "sil_getBalance/x", true},
		{"*", "anything", true},

		// Anchored: partial matches fail without wildcards.
		{"sil_getBalance", "sil_getBalance/balance-0", false},
		{"balance-0", "sil_getBalance/balance-0", false},

		// ? matches one character.
		{"sil_?etBalance", "sil_getBalance", true},
		{"sil_?etBalance", "sil_getgBalance", false},
