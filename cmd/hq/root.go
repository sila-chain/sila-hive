...
import (
	...
	"github.com/sila-chain/sila-hive/cmd/hq/internal/api"
	"github.com/sila-chain/sila-hive/cmd/hq/internal/cache"
...
func addGlobalFlags(fs *flag.FlagSet) {
	fs.StringVar(&baseURL, "base-url", "https://hive.silapandaops.io", "Hive server base URL")
